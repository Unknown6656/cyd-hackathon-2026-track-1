...
Companion evidence (valardomate): `../../valardomate/results/evidence.jsonl` (per-probe log), `../../valardomate/attack.py` (framing batteries), `../../valardomate/target_openapi.json` (captured API spec), `../../valardomate/exploit_writups/sup-1-gemma.md` (his standalone sup-1-gemma write-up). His independent gemma sup-1 reproduction is cited in `02_sup1_gas_cylinder_lock.md`; his held-battery results back the "what held" claims in `report.md`.
